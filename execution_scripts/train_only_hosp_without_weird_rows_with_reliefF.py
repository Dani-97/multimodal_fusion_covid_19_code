...
logs_dir_path_list = ['../results/only_hospitalized_without_weird_rows/']*nofexperiments
logs_file_name_list = (['dt_%s_feature_reliefF_oversampling_results.csv']*(nofexperiments-1)) + \
                            ['dt_%s_features_oversampling_results.csv']
model_list = ['DT_Classifier']*nofexperiments
dataset_path_list = ['../built_dataset/only_hospitalized_without_weird_rows.csv']*nofexperiments
balancing_list = ['Oversampling']*nofexperiments
feature_retrieval_list = (['ReliefF']*(nofexperiments-1)) + ['No']
...
store_features_selection_report_list = ['']*nofexperiments
...
logs_file_name_list = (['xgboost_%s_feature_reliefF_oversampling_results.csv']*(nofexperiments-1)) + \
...
logs_file_name_list = (['kNN_%s_feature_reliefF_oversampling_results.csv']*(nofexperiments-1)) + \
...
logs_file_name_list = (['mlp_%s_feature_reliefF_oversampling_results.csv']*(nofexperiments-1)) + \
...
logs_file_name_list = (['svm_%s_feature_reliefF_oversampling_results.csv']*(nofexperiments-1)) + \
