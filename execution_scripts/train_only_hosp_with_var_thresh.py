...
logs_file_name_list = ['dt_%s_var_thresh_selector_oversampling_results.csv']*nofexperiments
...
logs_file_name_list = ['xgboost_%s_var_thresh_selector_oversampling_results.csv']*nofexperiments
...
logs_file_name_list = ['kNN_%s_var_thresh_selector_oversampling_results.csv']*nofexperiments
...
logs_file_name_list = ['mlp_%s_var_thresh_selector_oversampling_results.csv']*nofexperiments
...
logs_file_name_list = ['svm_%s_var_thresh_selector_oversampling_results.csv']*nofexperiments
