...
logs_dir_path_list = ['../results/only_hospitalized_urgency_time/']*nofexperiments
logs_file_name_list = (['dt_%s_feature_ftest_oversampling_results.csv']*(nofexperiments-1)) + \
                            ['dt_%s_features_oversampling_results.csv']
model_list = ['DT_Regressor']*nofexperiments
dataset_path_list = ['../built_dataset/only_hospitalized_with_urgency_time_without_weird_rows.csv']*nofexperiments
balancing_list = ['No']*nofexperiments
...
model_list = ['XGBoost_Regressor']*nofexperiments
...
model_list = ['kNN_Regressor']*nofexperiments
...
model_list = ['MLP_Regressor']*nofexperiments
...
model_list = ['SVM_Regressor']*nofexperiments
