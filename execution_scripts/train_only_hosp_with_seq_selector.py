...
logs_file_name_list = ['dt_%s_feature_seq_selector_oversampling_results.csv']*nofexperiments
...
feature_retrieval_list = ['SequentialSelector']*nofexperiments
...
logs_file_name_list = ['xgboost_%s_feature_seq_selector_oversampling_results.csv']*nofexperiments
...
logs_file_name_list = ['kNN_%s_feature_seq_selector_oversampling_results.csv']*nofexperiments
...
logs_file_name_list = ['mlp_%s_feature_seq_selector_oversampling_results.csv']*nofexperiments
...
logs_file_name_list = ['svm_%s_feature_seq_selector_oversampling_results.csv']*nofexperiments
