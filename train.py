...
def main():
    ...
    parser.add_argument("--preprocessing", help="The preprocessing method that is desired to be selected", \
                            choices=['No', 'Standardization'], required=True)
    ...
    parser.add_argument("--nof_folds", help="Number of different folds of the cross validation process.", type=int, required=True)
    parser.add_argument("--nofsplits", help="Number of different holdouts to be performed", type=int, required=True)
