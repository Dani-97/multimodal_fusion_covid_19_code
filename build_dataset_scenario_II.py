...
def main():
    ...
    parser.add_argument('--dataset_version', type=str, choices=['full', 'simplified'], required=True, \
                help='Select if you want all the variables or you want to remove the patients ids and drop the duplicates.')
    ...
    func_to_execute = 'build_' + args.dataset_version + '_dataset_scenario_II'
